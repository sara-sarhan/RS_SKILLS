    ...
    if list_of_contents is not None:
        ...
        html.H3("Resumes",className="me-1"),
            ...
            dbc.Modal(
                ...
                html.Div(dbc.Button("Get Jobs Recommandations"), style={"text-align": "center"},
            ...
            card = dbc.Card(
                [
                    ...
                    dbc.CardBody([
                       ...
                       rs, striped=True, bordered=True, hover=True, index=False,  
                       size='sm', 
...
if __name__ == "__main__":
    ...
    ctrl.folder=None
    serve(app.server, host="0.0.0.0",port=8085)
